...
function disableAllFeildExceptRollno() {
  ...
  $('#stdbirthDate').prop('disabled', true);
  $('#stdAddress').prop('disabled', true);
  $('#stdEnroll').prop('disabled', true);
...
function getStd() {
  if ($('#stdRoll').val() === "") { // if roll number is not given then disable all feild
    disableAllFeildExceptRollno();
} else if ($('#stdRoll').val() < 1) { // if roll number is not valid (i.e roll-no <1)
    disableAllFeildExceptRollno();
    alert("Invalid Roll Number");
    $('#stdRoll').focus;
}else{
  ...
  //Enable all Fields
  $('#stdRoll').prop('disabled', false);
  $('#stdName').prop('disabled', false);
  $('#stdClass').prop('disabled', false);
  $('#stdBirthdate').prop('disabled', false);
  $('#stdAddress').prop('disabled', false);
  $('#stdEnroll').prop('disabled', false);
